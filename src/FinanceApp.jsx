      ...
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6">
        <div className="rounded-3xl border border-amber-900/30 bg-gradient-to-br from-zinc-900 to-amber-950/30 p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-zinc-400">
            ...
            en la raíz del proyecto y pegá tu <span className="text-zinc-200">Project URL</span> y tu{" "}
      ...
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6">
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-3">
          ...
          {status === "sent" ? (
            ...
            <Button type="submit" variant="bronze" className="w-full" disabled={status === "sending"}>
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      dispatch({
        type: "HYDRATE",
        payload: {
          loans: Array.isArray(data[STORAGE_KEYS.loans]) ? data[STORAGE_KEYS.loans] : [],
          clients: Array.isArray(data[STORAGE_KEYS.clients]) ? data[STORAGE_KEYS.clients] : [],
